...
//
//     final Listmodelapi = ListmodelapiFromJson(jsonString);

import 'dart:convert';

Listmodelapi ListmodelapiFromJson(String str) =>
    Listmodelapi.fromJson(json.decode(str));

String ListmodelapiToJson(Listmodelapi data) => json.encode(data.toJson());
...
class Listmodelapi {
  ...
  factory Listmodelapi.fromJson(Map<String, dynamic> json) => Listmodelapi(
...
class Data {
  ...
  Map<String, dynamic> toJson() => {
        "leads": leads == null
            ? []
            : List<dynamic>.from(leads!.map((x) => x.toJson())),
